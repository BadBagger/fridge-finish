...
class FridgeFinishRepository(
    ...
    private fun builtInRecipes(): List<SeedRecipe> = listOf(
        seedRecipe("Quick omelet", 15, "Use eggs with greens and a little dairy.", "Whisk eggs, cook with chopped greens or vegetables, then add cheese if available.", "eggs:egg", "spinach or peppers:spinach,tomato,pepper,onion,lettuce:PRODUCE", "shredded cheese:cheese,milk,yogurt:DAIRY"),
        ...
        seedRecipe("Leftover grain bowl", 12, "Use leftovers first with a pantry base.", "Warm leftovers with rice, pasta, or grains. Add greens or sauce if available.", "leftovers:leftover:LEFTOVERS", "rice or grain:rice,quinoa,pasta,noodle:PANTRY", "spinach or peppers:spinach,tomato,pepper,onion,lettuce:PRODUCE"),
        ...
        seedRecipe("Pasta clean-out", 20, "Use pantry pasta with vegetables or leftovers.", "Cook pasta, then toss with vegetables, leftovers, and sauce or condiments.", "pasta:pasta,noodle:PANTRY", "tomatoes or spinach:tomato,spinach,pepper,onion,broccoli:PRODUCE", "pasta sauce:sauce,leftover,chicken,meat:CONDIMENTS"),
